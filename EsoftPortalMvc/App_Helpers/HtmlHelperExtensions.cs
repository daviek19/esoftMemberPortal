...
namespace EsoftPortalMvc
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string area,string controller,string action, string attribute)
        {
            ...
            var hasArea = area.Equals(currentArea, StringComparison.InvariantCultureIgnoreCase);
            ...
            bool routeIf = hasAction && hasController && hasArea;
            return routeIf ? new HtmlString(attribute) : new HtmlString(string.Empty);
           // return hasArea || hasController ? new HtmlString(attribute) : new HtmlString(string.Empty);
          // return (hasAction || hasController || hasArea) ? new HtmlString(attribute) : new HtmlString(string.Empty);
        }
        ...
        // Get Current Executing Area
        public static string GetCurrentArea(this HtmlHelper helper)
        {
