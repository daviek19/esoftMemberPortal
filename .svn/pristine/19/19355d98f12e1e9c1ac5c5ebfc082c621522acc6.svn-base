...
namespace EstateManagementMvc.Models
{
    ...
    public class CachingProvider
    {
        ...
        public static void Add<T>(T objectToCache, string key, int durationInMinutes) where T : class
        {
            Cache.Add(key, objectToCache, DateTime.Now.AddMinutes(durationInMinutes));
        }
        /// <summary>
        /// Insert value into the cache using
        /// appropriate name/value pairs
